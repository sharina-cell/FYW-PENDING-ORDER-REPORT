...
def generate_excel(df: pd.DataFrame, report_date: datetime = None) -> BytesIO:
    """
    ...
    COL_WIDTHS   = [12, 10, 22, 22, 44, 28, 6, 18, 13, 20, 20, 20, 25, 18]
    ...
    BRAND_WIDTHS = [10, 22, 22, 44, 28, 6, 18, 13, 20, 20, 20, 25, 18]
